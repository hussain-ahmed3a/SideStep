...
import {Container,Footer,FooterTab,Button,Content,Header,Body,Left,Right,Title} from 'native-base';
    ...
    render(){
        return(
          <Container  style={styles.container}>
            ...
            <Body >
            <Title style={{color:'black',fontSize:25,marginHorizontal:20}}>Priority</Title>
            </Body>
             ...
             <Right>
              ...
              <FooterTab style={{flexDirection:'row',backgroundColor:'#F0BA00'}}>
                ...
                <Button style={{borderTopWidth:2}} onPress={()=> this.props.navigation.navigate('Priority')}>
